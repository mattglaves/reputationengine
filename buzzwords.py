...
# From - https://github.com/sameerkumar18/corporate-bs-generator-api
...
'accurate', 'adaptive', 'alternative', 'an expanded array of', 'B2B', 'B2C', 'backend',
...
'influencer','wheelhouse','viral','millennial','bitcoin','cryptocurrency','freemium','disruptor'
]
